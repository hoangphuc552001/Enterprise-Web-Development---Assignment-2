...
export type PopularActorsResponse = paths["/3/person/popular"]["get"]["responses"][200]["content"]["application/json"];

export type BaseActorProps = NonNullable<PopularActorsResponse["results"]>[number];

export type DiscoverTvResponse = paths["/3/discover/tv"]["get"]["responses"][200]["content"]["application/json"];

export type BaseTvSeriesProps = NonNullable<DiscoverTvResponse["results"]>[number];

export type ActorDetailsProps = paths["/3/person/{person_id}"]["get"]["responses"][200]["content"]["application/json"];

export type TvSeriesDetailsProps = paths["/3/tv/{series_id}"]["get"]["responses"][200]["content"]["application/json"];
